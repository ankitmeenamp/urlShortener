...
export const createAcessToken = async({id, name, email, sessionId})=>{
...
export const refreshTokens = async (refreshToken)=>{
    try {
        ...
        const newAccessToken =await createAcessToken(userInfo)
...
export const authenticateUser = async({req, res, user, email, name })=>{
